...
- Current references reviewed: FDA dietary supplement oversight, structure and function claims, adverse event reporting, medical foods, CBD, and homeopathy resources; NCCIH St. John's wort, kava, and red yeast rice resources; and NIH Office of Dietary Supplements folate, iron, and vitamin D fact sheets
...
- Assessment: 148 original questions across 37 distinct concept groups and four difficulty levels, with ten sampled without replacement per attempt and answer order randomized
- Source reconciliation: the FDA postmarket boundary was corrected; third party verification was separated from proof of efficacy; blanket bleeding mnemonics were replaced by individualized ingredient, dose, procedure, and medication risk assessment; beverage and concentrated extract exposure were separated; ephedra and DMAA regulatory safety was clarified; licorice, red yeast rice, St. John's wort, kava, CBD, homeopathy, and medical foods received current evidence and regulatory boundaries; dietary folate equivalents and targeted nutrient assessment replaced indiscriminate supplementation; and obsolete pregnancy letter categories were excluded
...
- Automated verification: 148 unique question IDs, 37 distinct concept groups, no duplicate answer-choice sets, valid links to all ten lessons, four difficulty levels, ten diagrams, and no em dash or en dash characters in public module prose
