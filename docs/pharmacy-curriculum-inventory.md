...
- Automated verification: 140 unique question IDs, 35 distinct concept groups, no duplicate answer choices, valid links to all ten lessons, four difficulty levels, ten diagrams, current injectable and intranasal rescue-device coverage, and no em dash or en dash characters in public module prose
...
- Build verification: Next.js production build passed August 27, 2026 with 547 static pages generated after intranasal epinephrine and curriculum ordering updates
