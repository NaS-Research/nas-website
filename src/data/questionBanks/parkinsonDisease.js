const concepts = [
  ...
  ["circuit-adaptation", "Dopamine loss changes direct and indirect basal-ganglia pathway signaling, but clinical disability also reflects distributed motor, cognitive, autonomic, and brainstem networks.", "Use circuit reasoning to explain bradykinesia and treatment response without reducing the entire disease to one transmitter or one pathway.", "Assuming dopamine replacement reverses the neurodegenerative process can create unrealistic expectations about progression and nonmotor disease."],
  ["nonmotor-surveillance", "Nonmotor Parkinson symptoms may fluctuate with medication state, progress independently, or arise from treatment, comorbidity, or another acute illness.", "Screen cognition, mood, psychosis, sleep, autonomic function, pain, swallowing, and impulse control repeatedly and investigate meaningful change.", "Attributing sudden confusion or hallucinations automatically to Parkinson progression can miss infection, medication toxicity, or another reversible cause."],
  ["fluctuation-integration", "Off time, delayed on, dose failure, freezing, peak-dose dyskinesia, diphasic dyskinesia, and off dystonia represent different relationships between exposure and movement.", "Overlay a timed dose, meal, motor, dyskinesia, rescue, and sleep diary before changing levodopa delivery or adjunctive therapy.", "Treating every involuntary movement by simply increasing levodopa can worsen peak-dose dyskinesia and conceal the actual fluctuation pattern."],
  ["psychosis-safety", "Parkinson psychosis treatment must preserve motor function while accounting for cognition, orthostasis, QT risk, sedation, falls, interactions, caregiver observations, and the possibility of delirium.", "Remove reversible causes, simplify provoking therapy carefully, and monitor the exact motor-sparing strategy against hallucinations, function, blood pressure, rhythm risk, and alertness.", "Suppressing hallucinations with potent dopamine blockade can exchange one danger for severe rigidity, immobility, aspiration, and loss of independence."],
];

const reviewLessonByConcept = {
  "motor-circuit": "motor-circuit",
  "circuit-adaptation": "motor-circuit",
  diagnosis: "diagnosis",
  differential: "diagnosis",
  nonmotor: "nonmotor-system",
  "nonmotor-surveillance": "nonmotor-system",
  "levodopa-selection": "levodopa-system",
  "levodopa-mechanism": "levodopa-system",
  "levodopa-administration": "dose-timing",
  formulations: "levodopa-system",
  "wearing-off": "dose-timing",
  "dopamine-agonists": "adjunct-map",
  "agonist-withdrawal": "adjunct-map",
  "mao-b": "adjunct-map",
  comt: "adjunct-map",
  amantadine: "adjunct-map",
  anticholinergics: "adjunct-map",
  dyskinesia: "dyskinesia",
  "fluctuation-integration": "dyskinesia",
  rescue: "advanced-therapy",
  "advanced-therapy": "advanced-therapy",
  psychosis: "psychosis",
  "psychosis-safety": "psychosis",
  orthostasis: "autonomic",
  swallowing: "autonomic",
  "medication-safety": "hospital-safety",
  "withdrawal-emergency": "hospital-safety",
