...
const concepts = [
  c("hpa-axis", "signaling", "the hypothalamic-pituitary-adrenal axis", "CRH stimulates pituitary ACTH, ACTH stimulates adrenal cortisol, and cortisol limits further CRH and ACTH release through negative feedback.", "Use the axis to predict why sustained exogenous glucocorticoid exposure can suppress endogenous cortisol production.", "Assuming exogenous steroid exposure increases ACTH ignores cortisol-mediated negative feedback.", "A patient on chronic prednisone has low ACTH and low endogenous cortisol production.", "Recognize expected suppression of CRH and ACTH signaling by exogenous glucocorticoid exposure.", "Negative feedback explains the low upstream signals and the risk that cortisol production will not recover immediately after discontinuation."),
  c("receptor-action", "signaling", "glucocorticoid receptor signaling", "The glucocorticoid receptor is an intracellular receptor that changes gene transcription and also produces rapid non-genomic effects that reduce inflammatory signaling.", "Connect receptor activation with reduced cytokine transcription, leukocyte trafficking, vascular permeability, and inflammatory mediator production.", "Describing glucocorticoids as direct neutralizing antibodies misstates their cellular mechanism.", "A learner asks why steroid effects persist beyond the plasma half-life.", "Explain that altered gene transcription and biologic effects outlast plasma exposure.", "Biologic duration reflects receptor and transcriptional effects, not plasma concentration alone."),
  c("mineralocorticoid", "signaling", "glucocorticoid and mineralocorticoid activity", "Systemic corticosteroids differ in anti-inflammatory potency, biologic duration, and sodium-retaining mineralocorticoid activity.", "Choose an agent by the clinical objective, required anti-inflammatory effect, duration, route, and fluid or electrolyte risk.", "Treating every corticosteroid as pharmacologically interchangeable ignores clinically important differences.", "A patient with edema needs potent anti-inflammatory therapy with minimal sodium retention.", "Compare equivalent anti-inflammatory doses and mineralocorticoid activity before selecting the agent.", "Dose equivalence does not erase differences in duration or salt-retaining activity."),
  c("local-systemic", "signaling", "local versus systemic glucocorticoid delivery", "Inhaled, topical, intra-articular, and locally acting products can reduce systemic exposure, but absorption and systemic adverse effects remain possible.", "Use the most targeted effective route and still reconcile total exposure across every formulation.", "Calling every local product free of systemic effects can miss cumulative exposure and adrenal suppression.", "A patient uses high-dose inhaled steroid plus repeated joint injections and develops cushingoid features.", "Assess cumulative exposure across all routes rather than dismissing non-oral products.", "Route can reduce exposure but does not guarantee zero systemic absorption."),
  c("replacement-treatment", "signaling", "replacement versus anti-inflammatory glucocorticoid use", "Physiologic replacement restores deficient cortisol, while anti-inflammatory or immunosuppressive therapy usually uses supraphysiologic exposure for a different clinical objective.", "Identify whether the regimen replaces a hormone or suppresses inflammation before interpreting dose, duration, adverse effects, or discontinuation.", "Treating replacement and anti-inflammatory dosing as the same task can create undertreatment, overexposure, or unsafe tapering.", "A patient with adrenal insufficiency is told to stop physiologic hydrocortisone because inflammation has resolved.", "Preserve required hormone replacement and separate it from any completed anti-inflammatory course.", "The indication determines whether glucocorticoid exposure is essential replacement or temporary disease treatment."),

  c("steroid-scaffold", "medicinal-chemistry", "the corticosteroid receptor-binding scaffold", "The fused steroid nucleus positions the A-ring 3-keto and 4-ene system, C11 oxygen function, C17 side chain, C20 carbonyl, and C21 oxygen function for receptor recognition and metabolism.", "Use the scaffold to explain why apparently small substitutions can change activity, selectivity, formulation, or duration.", "Memorizing drug names without locating their structural differences cannot explain changes in activity or delivery.", "A learner sees two corticosteroids with the same fused-ring nucleus but different substituents.", "Compare the positions and functions of the substituents before predicting how the products differ.", "The shared scaffold establishes the family, while substitutions tune clinically relevant behavior."),
  ...
  c("indication-plan", "starting-therapy", "an indication-specific glucocorticoid plan", "Dose, route, duration, and taper depend on the disease, severity, treatment goal, and concurrent steroid-sparing therapy.", "Write the indication, expected duration, reassessment point, and exit strategy when therapy begins.", "Using a generic dose pack for every inflammatory condition can undertreat disease or add needless exposure.", "A patient is prescribed a methylprednisolone pack without a documented diagnosis or follow-up plan.", "Clarify the indication and build a disease-specific regimen before dispensing assumptions become treatment.", "A preprinted package is not a substitute for an indication-specific plan."),
  c("morning-dose", "starting-therapy", "circadian glucocorticoid administration", "A single daily systemic dose is often given in the morning to better align with endogenous cortisol rhythm and may reduce sleep disruption.", "Use morning administration when clinically appropriate while respecting disease-specific schedules and divided-dose needs.", "Moving every regimen to bedtime can worsen insomnia and depart from the intended schedule.", "A patient taking once-daily prednisone at bedtime reports severe insomnia.", "Confirm the regimen and discuss morning dosing if the indication permits.", "Timing can improve tolerability but must remain consistent with the prescribed treatment objective."),
  c("food-administration", "starting-therapy", "oral glucocorticoid administration with food", "Taking an oral glucocorticoid with food can reduce dyspepsia, although it does not eliminate ulcer or bleeding risk.", "Counsel on food, exact schedule, missed doses, and warning symptoms while reviewing other gastrointestinal risks.", "Claiming food fully prevents gastrointestinal bleeding can create false reassurance.", "A patient taking prednisone with naproxen assumes meals remove all stomach risk.", "Review additive gastrointestinal risk and warning signs rather than relying on food alone.", "Food may improve irritation but does not neutralize medication-related bleeding risk."),
  c("short-course", "starting-therapy", "short-course discontinuation", "The 2024 Endocrine Society guideline suggests that systemic therapy lasting less than three to four weeks usually can stop without tapering or adrenal testing when the clinical disease permits.", "Separate the need to taper for adrenal recovery from the need to prevent recurrence of the treated disease.", "Automatically tapering every five-day course because of HPA suppression applies an outdated universal rule.", "A patient completes five days of prednisone for a controlled indication and has no prior chronic exposure.", "Follow the disease plan and generally stop without an adrenal taper when no other risk changes the decision.", "Short courses usually do not require tapering for HPA recovery, though disease-specific treatment can differ."),
  c("dose-pack-boundary", "starting-therapy", "the limits of a prepackaged glucocorticoid taper", "A dose pack provides a convenient fixed sequence, but it does not establish the correct indication, starting dose, duration, or taper for every inflammatory condition.", "Verify that the packaged regimen matches the disease, severity, patient, and intended follow-up.", "Choosing a dose pack solely because it contains a taper can replace clinical reasoning with package geometry.", "A severe inflammatory flare is prescribed a standard six-day pack without reassessment or disease-specific dosing.", "Confirm whether the pack provides adequate treatment and create an indication-specific plan.", "Convenience is useful only after the regimen has been matched to the clinical problem."),

  c("suppression-threshold", "hpa-risk", "risk thresholds for glucocorticoid-induced adrenal insufficiency", "Risk is expected when oral exposure exceeds both about three to four weeks and a daily dose above physiologic equivalence, roughly 4 to 6 mg prednisone.", "Assess dose, duration, potency, route, repeated courses, cushingoid features, and interacting medicines rather than using one threshold alone.", "Using only the old 20 mg for two weeks vaccine threshold to judge adrenal suppression confuses two different questions.", "A patient has taken prednisone 10 mg daily for eight weeks.", "Treat the exposure as a meaningful HPA suppression risk and plan discontinuation accordingly.", "Adrenal risk occurs at lower doses and a different duration than the CDC live-vaccine threshold."),
  c("cushing-features", "hpa-risk", "exogenous Cushing syndrome as an adrenal-risk signal", "Cushingoid features from exogenous glucocorticoids indicate meaningful systemic exposure and make adrenal suppression more likely.", "Review all steroid routes and avoid abrupt discontinuation when cushingoid features suggest sustained exposure.", "Ignoring cushingoid appearance because the oral dose is low can miss exposure from injections, inhaled therapy, or interactions.", "A patient on inhaled fluticasone plus a strong CYP3A4 inhibitor develops facial rounding and proximal weakness.", "Evaluate systemic glucocorticoid excess and HPA suppression from the combined exposure.", "Clinical features can reveal cumulative exposure that the medication list alone obscures."),
  c("withdrawal-differential", "hpa-risk", "glucocorticoid withdrawal, adrenal insufficiency, and disease flare", "Fatigue, pain, weakness, mood change, nausea, and low blood pressure can overlap across withdrawal syndrome, adrenal insufficiency, and recurrence of the underlying disease.", "Use timing, dose, vital signs, electrolytes, disease markers, and clinical severity to distinguish the possibilities.", "Labeling every symptom during taper as disease flare can drive unnecessary dose escalation.", "A patient near physiologic prednisone dosing develops fatigue, nausea, and orthostatic symptoms without inflammatory findings.", "Assess for adrenal insufficiency and withdrawal rather than assuming the original disease has returned.", "Overlapping symptoms require a structured differential and safety assessment."),
  c("nonoral-risk", "hpa-risk", "adrenal risk from non-oral glucocorticoids", "High-dose inhaled therapy, prolonged topical use, repeated injections, multiple formulations, or CYP3A4 interactions can produce clinically important systemic exposure.", "Reconcile every route and ask about recent procedures, creams, inhalers, eye products, and injections.", "Counting only tablets can miss the dominant source of glucocorticoid exposure.", "A patient denies oral steroids but receives frequent epidural injections and uses potent topical therapy.", "Include both sources in the HPA risk assessment.", "Systemic exposure is determined by absorption and cumulative therapy, not the route label alone."),
  ...
  c("hyperglycemia", "metabolic-toxicity", "glucocorticoid-induced hyperglycemia", "Intermediate-acting morning prednisone often produces rising afternoon and evening glucose even when fasting glucose is near normal.", "Match glucose monitoring and therapy to the glucocorticoid type, timing, nutrition, dose changes, and the patient's diabetes status.", "Checking only fasting glucose can miss the dominant steroid-related pattern.", "A hospitalized patient on morning prednisone has normal fasting glucose but repeated evening values above 250 mg/dL.", "Treat the daytime pattern and adjust therapy as the steroid dose changes.", "The 2026 ADA standard emphasizes timing-specific monitoring and coordinated insulin adjustment."),
  c("fluid-pressure", "metabolic-toxicity", "blood pressure and fluid effects", "Glucocorticoid and mineralocorticoid activity can increase blood pressure, sodium retention, edema, and potassium loss, with risk varying by agent and patient.", "Monitor weight, edema, blood pressure, electrolytes, heart failure status, and interacting medicines.", "Using an equivalent anti-inflammatory dose without considering salt-retaining activity can worsen congestion.", "A patient with heart failure develops edema after systemic steroid initiation.", "Reassess indication, agent, dose, volume status, sodium and potassium, and the need for continued therapy.", "Agent selection and monitoring should reflect cardiovascular and electrolyte vulnerability."),
  c("neuropsychiatric", "metabolic-toxicity", "glucocorticoid neuropsychiatric effects", "Insomnia, mood change, agitation, depression, mania, delirium, and psychosis can occur, often with higher exposure but not with perfect predictability.", "Establish baseline mental health, counsel the patient and support person, and respond promptly to severe behavioral change or suicidality.", "Dismissing new mania as expected and harmless can delay urgent treatment.", "A patient develops sleeplessness, pressured speech, and risky behavior after high-dose prednisone.", "Arrange urgent clinical assessment and coordinate steroid modification with the treating team.", "Severe neuropsychiatric effects require active management, not routine reassurance."),
  ...
  c("eye-muscle-growth", "bone-tissue-protection", "eye, muscle, skin, and growth toxicity", "Long-term glucocorticoids can contribute to cataracts, glaucoma, proximal myopathy, skin fragility, impaired wound healing, and growth suppression.", "Monitor vision symptoms, strength, skin, wound healing, and growth in children according to exposure and risk.", "Tracking only glucose and blood pressure misses organ systems affected by chronic therapy.", "A child on prolonged systemic steroid therapy crosses downward on the growth curve.", "Reassess cumulative exposure, disease control, steroid-sparing options, nutrition, and pediatric growth monitoring.", "Growth is a required longitudinal safety outcome in children receiving sustained therapy."),
  c("cyp3a4-inhibition", "longitudinal-safety", "CYP3A4 inhibition and glucocorticoid exposure", "Strong CYP3A4 inhibitors can increase exposure to susceptible glucocorticoids and amplify cushingoid and adrenal-suppression risk.", "Review antivirals, azoles, macrolides, and other inhibitors across oral, injected, inhaled, and topical steroid use.", "Assuming a locally administered steroid cannot interact can miss severe systemic toxicity.", "A patient using inhaled fluticasone starts ritonavir and develops cushingoid features.", "Recognize a high-risk interaction and coordinate an alternative steroid or interacting medicine.", "CYP3A4 inhibition can transform a local regimen into clinically important systemic exposure."),
