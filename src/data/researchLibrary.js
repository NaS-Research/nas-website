export const researchItems = [
  ...
  },
  {
    ...
    title: "Introducing the NaS Cortex: A Digital Foundation for Life Science",
    shortTitle: "Introducing the NaS Cortex",
    type: "Research Note",
    ...
    pdfUrl: null,
    abstract:
      "A concept note outlining NaS Cortex, a proposed computational layer for organizing scientific knowledge, tools, and research workflows.",
    summary:
      "NaS Cortex is a working concept for connecting research information, computational tools, and automated workflows within one coherent scientific environment.",
    sections: [
      {
        id: "idea",
        title: "1. The idea",
        paragraphs: [
          "Scientific work is often distributed across papers, notebooks, datasets, software, and institutional systems. NaS Cortex is a proposal for bringing those elements into a more legible computational environment.",
          "The concept begins with organization: research objects should be discoverable, attributable, versioned, and connected to the questions and methods that produced them.",
        ],
      },
      {
        id: "principles",
        ...
        paragraphs: [
          "The system is envisioned around provenance, interoperability, reproducibility, and access. Each layer should make it easier to understand where information came from and how a result was produced.",
          "Cortex remains a design direction rather than a released platform. This note establishes a vocabulary for future technical work and public documentation.",
        ],
      },
      {
        id: "architecture",
        ...
        paragraphs: [
          "A future architecture could connect a structured research library, retrieval systems, computational services, models such as Nicole, and interfaces for experimental planning and analysis.",
          "Each component would be independently testable while contributing to a shared representation of scientific work.",
        ],
      },
      {
        id: "next-steps",
        title: "4. Next steps",
        paragraphs: [
          "The immediate work is to build the public research library, establish consistent publication metadata, and document the first NaS systems in a form that can evolve over time.",
        ],
      },
    ],
  },
