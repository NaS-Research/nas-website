const diagrams = {
  ...
  "diuretic-thiazide": { eyebrow: "Thiazide-like therapy", title: "Block NCC, then distinguish natriuresis from paradoxical antidiuresis.", accent: "#c3a165", columns: [["Transport", "NCC inhibition", "Distal sodium delivery rises"], ["Potassium", "Collecting-duct secretion", "Hypokalemic alkalosis risk"], ["Calcium", "Urinary loss falls", "Distinct from loop effect"], ["Nephrogenic DI", "Proximal reclamation rises", "Distal water delivery falls"]] },
  "diuretic-potassium": { eyebrow: "Collecting duct", title: "Preserve potassium by reducing ENaC-driven secretion.", accent: "#8ba679", columns: [["Spironolactone", "Mineralocorticoid receptor", "Slow genomic antagonism"], ["Eplerenone", "More selective receptor profile", "CYP3A exposure matters"], ["Amiloride", "ENaC and lithium entry", "Direct luminal action"], ["Safety", "Hyperkalemia + acidosis", "Kidney function and regimen burden"]] },
  "diuretic-other": { eyebrow: "Specialized diuresis", title: "Not every water-removing drug is a natriuretic.", accent: "#9a8ab9", columns: [["Acetazolamide", "Bicarbonate + altitude", "Avoid in cirrhosis"], ["Mannitol", "Filtered osmole", "Compartment shifts before excretion"], ["Tolvaptan", "Controlled aquaresis", "Hospital sodium monitoring"], ["SGLT2 inhibition", "Proximal glucose and sodium", "Broader cardiorenal outcomes"]] },
