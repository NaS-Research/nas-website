export const alopeciaVisualTypes = [
  ...
  "eyelash-hypotrichosis", "jak-selection", "monitoring-support",
];
...
const diagrams = {
  ...
  "topical-minoxidil": ["Follicle stimulation", "Connect delivery and activation with an incompletely defined growth mechanism", ["Deliver", "Dry scalp application", "Product-specific dose and schedule"], ["Activate", "Minoxidil sulfate", "Follicular sulfotransferase matters"], ["Investigate", "Potassium-channel effects", "Experimental support; not a complete clinical explanation"], ["Maintain", "Continue treatment", "Stopping removes the benefit"]],
  ...
  "jak-selection": ["Product selection", "Three options require different eligibility and monitoring decisions", ["Baricitinib", "Kidney function and dose", "Check OAT3 interactions"], ["Ritlecitinib", "Age 12 and older", "Distinguish platelet start and stop thresholds"], ["Deuruxolitinib", "CYP2C9 genotype", "Screen inhibitors before treatment"], ["Follow up", "Infection and laboratory review", "Use the selected product label"]],
  ...
  "eyelash-hypotrichosis": ["Eyelash care", "Check indication, technique, eye medicines, and response", ["Identify", "Lash concern", "Investigate the cause"], ["Apply", "Exact prescription", "Demonstrate technique"], ["Reconcile", "Eye medicines", "Coordinate the plan"], ["Review", "Benefit and harm", "Follow changing symptoms"]],
