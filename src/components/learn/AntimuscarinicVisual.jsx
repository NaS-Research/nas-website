const diagrams = {
  "antimuscarinic-mechanism": { eyebrow: "Receptor blockade", title: "Response emerges tissue by tissue.", accent: "#d5a475", columns: [["Target", "M1 through M5", "Competitive receptor antagonism"], ["Access", "Charge and polarity", "Peripheral or central exposure"], ["Threshold", "Tone and receptor reserve", "Organs respond at different exposures"], ["Risk", "Reserve and burden", "Benefit can become toxicity"]] },
  ...
  "antimuscarinic-bladder": { eyebrow: "Storage phase", title: "Treat urgency, not every form of leakage.", accent: "#80a8c5", columns: [["Phenotype", "Urgency or stress", "Different mechanisms"], ["Select", "Agent + formulation", "CNS access and interactions"], ["Measure", "Urgency + leakage", "Voids, residual when indicated"], ["Reassess", "Benefit versus burden", "Cognition, bowel, mouth, vision"]] },
  ...
  "antimuscarinic-applications": { eyebrow: "Clinical matching", title: "Route, tissue, and duration define the use.", accent: "#b59ac8", columns: [["Iris", "Sphincter blockade", "Mydriasis"], ["Ciliary muscle", "Accommodation blockade", "Cycloplegia"], ["CNS", "Benztropine", "Selected movement symptoms"], ["Motion", "Scopolamine patch", "Vestibular signaling"]] },
