...
const diagrams = {
  ...
  "gu-medchem-antimuscarinic": ["Distribution logic", "Charge, metabolism, and route shape antimuscarinic burden", ["Bind", "Cationic center", "Hydrophobic groups complete muscarinic recognition"], ["Transform", "Parent and metabolite", "Oxybutynin, tolterodine, and fesoterodine create distinct active-species patterns"], ["Partition", "Tertiary or quaternary", "Charge, transport, and lipophilicity shape membrane access"], ["Select", "Muscarinic subtype", "Relative M3 affinity does not confine exposure to the bladder"]],
  ...
  "gu-medchem-product": ["Product reality", "The molecule is only one layer of the medicine", ["Define", "Active species", "Parent, prodrug, metabolite, salt, and stereochemistry"], ["Route", "Local delivery", "Alprostadil uses cAMP through urethral or intracavernosal exposure"], ["Verify", "Regulatory label", "A foreign indication or plausible mechanism is not a US approval"], ["Decide", "Patient context", "Organ function, evidence, preferences, and monitoring"]],
};
