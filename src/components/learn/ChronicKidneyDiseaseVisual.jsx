const diagrams = {
  ...
  "ckd-mechanism": { accent: "#b98464", eyebrow: "Disease continuum", title: "Compensation can conceal progression", columns: [["Risk", "Find disease early", "Pair filtration with urine albumin in people at increased risk"], ["Adaptation", "Single-nephron hyperfiltration", "Preserved total GFR can coexist with rising intraglomerular stress"], ["Progression", "Inflammation and fibrosis", "Nephron loss, systemic complications, and symptoms emerge over time"]] },
  ...
  "ckd-monitoring": { accent: "#caa56e", eyebrow: "Treatment control loop", title: "Baseline, response, threshold, next action", columns: [["Measure", "Pressure, creatinine, potassium", "Choose timing from therapy and individual risk"], ["Interpret", "Expected or dangerous", "Separate hemodynamic response from progressive injury"], ["Act", "Mitigate, hold, restart", "Document thresholds, timing, and clinical ownership"]] },
