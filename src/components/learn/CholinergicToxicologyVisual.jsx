const diagrams = {
  ...
  "tox-syndrome-domains": { eyebrow: "Cholinergic syndrome", title: "Three receptor domains, one respiratory threat.", accent: "#c98678", columns: [["Muscarinic", "Wet physiology", "Bronchorrhea, bronchospasm, bradycardia"], ["Nicotinic", "Motor + ganglia", "Fasciculation, weakness, paralysis"], ["Central", "Brain", "Confusion, seizure, coma"], ["Priority", "Ventilation", "Airway, oxygenation, suction"]] },
  ...
  "tox-oxime": { eyebrow: "Enzyme reactivation", title: "Oxime access competes with aging.", accent: "#a492c5", columns: [["Bind", "Oxime approaches phosphorus", "Agent compatibility matters"], ["Reactivate", "Cleavage from serine", "Best before aging"], ["Recover", "NMJ function", "Ventilation still supported"], ["Limit", "Central + aged enzyme", "Not a substitute for atropine"]] },
